...
namespace AccountService.Infrastructure.Database.Migrations
{
    ...
    [Migration("20250401195218_Accounts_Add_InitMigrations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AccountService.Domain.Accounts.AdminAccount", b =>
                {
            ...
            modelBuilder.Entity("AccountService.Domain.Accounts.ParticipantAccount", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id");
            ...
            modelBuilder.Entity("AccountService.Domain.Accounts.VolunteerAccount", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id");
            ...
            modelBuilder.Entity("AccountService.Domain.Aggregates.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("AccountService.Domain.Aggregates.RolePermission", b =>
                {
            ...
            modelBuilder.Entity("AccountService.Domain.Aggregates.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("AccountService.Domain.Others.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("AccountService.Domain.Aggregates.User", b =>
                {
                    b.HasOne("AccountService.Domain.Accounts.AdminAccount", "Admin")
                        .WithOne("User")
                        .HasForeignKey("AccountService.Domain.Aggregates.User", "AdminUserId")
                        .HasConstraintName("fk_users_admin_accounts_admin_user_id");

                    b.HasOne("AccountService.Domain.Accounts.ParticipantAccount", "Participant")
                        .WithOne("User")
                        .HasForeignKey("AccountService.Domain.Aggregates.User", "ParticipantUserId")
                        .HasConstraintName("fk_users_participant_accounts_participant_user_id");

                    b.HasOne("AccountService.Domain.Aggregates.Role", "Role")
                        .WithMany()
                        .HasForeignKey("RoleId1")
                        .HasConstraintName("fk_users_roles_role_id1");

                    b.HasOne("AccountService.Domain.Accounts.VolunteerAccount", "Volunteer")
                        .WithOne("User")
                        .HasForeignKey("AccountService.Domain.Aggregates.User", "VolunteerUserId")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("AccountService.Domain.Aggregates.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("AccountService.Domain.Aggregates.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
