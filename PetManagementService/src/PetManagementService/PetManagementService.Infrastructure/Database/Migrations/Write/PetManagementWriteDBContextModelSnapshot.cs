...
{
    [DbContext(typeof(PetManagementWriteDBContext))]
    partial class PetManagementWriteDBContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetManagementService.Domain.PetManagment.VolunteerEntity.Volunteer", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("FullName", "PetManagementService.Domain.PetManagment.VolunteerEntity.Volunteer.FullName#FullName", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("PetManagementService.Domain.SpeciesManagment.BreedEntity.Breed", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("PetManagementService.Domain.SpeciesManagment.SpeciesEntity.Species", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("Id");
            ...
            modelBuilder.Entity("PetManagementService.Domain.PetManagment.PetEntity.Pet", b =>
                {
                    b.HasOne("PetManagementService.Domain.PetManagment.VolunteerEntity.Volunteer", null)
                        .WithMany("Pets")
                    ...
                    b.OwnsOne("PetManagementService.Domain.PetManagment.PetEntity.Pet.Requisites#ValueObjectList", "Requisites", b1 =>
                        {
                            b1.Property<Guid>("PetId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PetManagementService.Domain.SpeciesManagment.BreedEntity.Breed", b =>
                {
                    b.HasOne("PetManagementService.Domain.SpeciesManagment.SpeciesEntity.Species", null)
                        .WithMany("Breeds")
