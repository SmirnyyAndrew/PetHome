...
public class SetMainPhotoUseCase
{
    private readonly IReadDBContext _readDBContext;
    private readonly IVolunteerRepository _volunteerRepository;
    private readonly ILogger<SetMainPhotoUseCase> _logger;
    private readonly IUnitOfWork _unitOfWork;
    private readonly IValidator<SetMainPhotoCommand> _validator;

    public SetMainPhotoUseCase(
        IReadDBContext readDBContext,
        IVolunteerRepository volunteerRepository,
        ILogger<SetMainPhotoUseCase> logger,
